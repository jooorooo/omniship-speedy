<?php
/**
 * File for class SpeedyStructMakeAddressString
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructMakeAddressString originally named makeAddressString
 ...
 * @date 2017-05-16
 */
class SpeedyStructMakeAddressString extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $address;
    /**
     * Constructor method for makeAddressString
     * @see parent::__construct()
     * @param string $_sessionId
     * @param SpeedyStructParamAddress $_address
     * @return SpeedyStructMakeAddressString
     */
