<?php
/**
 * File for SpeedyWsdlClass to communicate with SOAP service
 * @package Speedy
 ...
 */
/**
 * SpeedyWsdlClass to communicate with SOAP service
 * 
 * @package Speedy
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-05-16
 */
class SpeedyWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://www.speedy.bg/eps/main01.wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses SpeedyWsdlClass::setLastError()
     * @uses SpeedyWsdlClass::initSoapClient()
     * @uses SpeedyWsdlClass::initInternArrayToIterate()
     * @uses SpeedyWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'SpeedyWsdlClass'))
            {
     ...
     * @uses SpeedyClassMap::classMap()
     * @uses SpeedyWsdlClass::getDefaultWsdlOptions()
     * @uses SpeedyWsdlClass::getSoapClientClassName()
     * @uses SpeedyWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('SpeedyClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = SpeedyClassMap::classMap();
     ...
     * If a class is named as {Speedy}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('SpeedySoapClient') && is_subclass_of('SpeedySoapClient','SoapClient'))
            return 'SpeedySoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses SpeedyWsdlClass::WSDL_CACHE_WSDL
     * @uses SpeedyWsdlClass::WSDL_COMPRESSION
     * @uses SpeedyWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses SpeedyWsdlClass::WSDL_ENCODING
     * @uses SpeedyWsdlClass::WSDL_EXCEPTIONS
     * @uses SpeedyWsdlClass::WSDL_FEATURES
     * @uses SpeedyWsdlClass::WSDL_LOGIN
     * @uses SpeedyWsdlClass::WSDL_PASSWORD
     * @uses SpeedyWsdlClass::WSDL_SOAP_VERSION
     * @uses SpeedyWsdlClass::WSDL_STREAM_CONTEXT
     * @uses SpeedyWsdlClass::WSDL_TRACE
     * @uses SpeedyWsdlClass::WSDL_TYPEMAP
     * @uses SpeedyWsdlClass::WSDL_URL
     * @uses SpeedyWsdlClass::VALUE_WSDL_URL
     * @uses SpeedyWsdlClass::WSDL_USER_AGENT
     * @uses SpeedyWsdlClass::WSDL_PROXY_HOST
     * @uses SpeedyWsdlClass::WSDL_PROXY_PORT
     * @uses SpeedyWsdlClass::WSDL_PROXY_LOGIN
     * @uses SpeedyWsdlClass::WSDL_PROXY_PASSWORD
     * @uses SpeedyWsdlClass::WSDL_LOCAL_CERT
     * @uses SpeedyWsdlClass::WSDL_PASSPHRASE
     * @uses SpeedyWsdlClass::WSDL_AUTHENTICATION
     * @uses SpeedyWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses SpeedyWsdlClass::getSoapClient()
     * @uses SpeedyWsdlClass::getFormatedXml()
     ...
     * @uses SpeedyWsdlClass::getSoapClient()
     * @uses SpeedyWsdlClass::convertStringHeadersToArray()
     ...
     * @uses SpeedyWsdlClass::getInternArrayToIterate()
     * @uses SpeedyWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses SpeedyWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses SpeedyWsdlClass::getInternArrayToIterateOffset()
     * @uses SpeedyWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses SpeedyWsdlClass::getInternArrayToIterateOffset()
     * @uses SpeedyWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses SpeedyWsdlClass::getAttributeName()
     * @uses SpeedyWsdlClass::__toString()
     * @uses SpeedyWsdlClass::_set()
     * @uses SpeedyWsdlClass::_get()
     * @uses SpeedyWsdlClass::setInternArrayToIterate()
     * @uses SpeedyWsdlClass::setInternArrayToIterateIsArray()
     * @uses SpeedyWsdlClass::setInternArrayToIterateOffset()
