<?php
/**
 * File for class SpeedyStructFinalizeBillOfLadingCreation
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructFinalizeBillOfLadingCreation originally named finalizeBillOfLadingCreation
 ...
 * @date 2017-05-16
 */
class SpeedyStructFinalizeBillOfLadingCreation extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $billOfLading;
    /**
     * Constructor method for finalizeBillOfLadingCreation
     * @see parent::__construct()
     * @param string $_sessionId
     * @param long $_billOfLading
     * @return SpeedyStructFinalizeBillOfLadingCreation
     */
