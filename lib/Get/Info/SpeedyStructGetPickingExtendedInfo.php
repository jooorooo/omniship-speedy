<?php
/**
 * File for class SpeedyStructGetPickingExtendedInfo
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructGetPickingExtendedInfo originally named getPickingExtendedInfo
 ...
 * @date 2017-05-16
 */
class SpeedyStructGetPickingExtendedInfo extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $billOfLading;
    /**
     * Constructor method for getPickingExtendedInfo
     * @see parent::__construct()
     * @param string $_sessionId
     * @param long $_billOfLading
     * @return SpeedyStructGetPickingExtendedInfo
     */
