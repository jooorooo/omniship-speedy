<?php
/**
 * File for class SpeedyStructListQuarters
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructListQuarters originally named listQuarters
 ...
 * @date 2017-05-16
 */
class SpeedyStructListQuarters extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $language;
    /**
     * Constructor method for listQuarters
     * @see parent::__construct()
     * @param string $_sessionId
     * @param string $_name
     * @param long $_siteId
     * @param SpeedyEnumParamLanguage $_language
     * @return SpeedyStructListQuarters
     */
