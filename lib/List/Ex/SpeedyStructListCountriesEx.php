<?php
/**
 * File for class SpeedyStructListCountriesEx
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructListCountriesEx originally named listCountriesEx
 ...
 * @date 2017-05-16
 */
class SpeedyStructListCountriesEx extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var SpeedyStructParamFilterCountry
     */
    public $filter;
    /**
     * The language
    ...
    public $language;
    /**
     * Constructor method for listCountriesEx
     * @see parent::__construct()
     * @param string $_sessionId
     * @param SpeedyStructParamFilterCountry $_filter
     * @param SpeedyEnumParamLanguage $_language
     * @return SpeedyStructListCountriesEx
     */
    ...
    /**
     * Get filter value
     * @return SpeedyStructParamFilterCountry|null
     */
    ...
    /**
     * Set filter value
     * @param SpeedyStructParamFilterCountry $_filter the filter
