<?php
/**
 * File for class SpeedyStructListOfficesEx
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructListOfficesEx originally named listOfficesEx
 ...
 * @date 2017-05-16
 */
class SpeedyStructListOfficesEx extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $countryId;
    /**
     * Constructor method for listOfficesEx
     ...
     * @return SpeedyStructListOfficesEx
     */
    public function __construct($_sessionId = NULL,$_name = NULL,$_siteId = NULL,$_language = NULL,$_countryId = NULL)
    {
        parent::__construct(array('sessionId'=>$_sessionId,'name'=>$_name,'siteId'=>$_siteId,'language'=>$_language,'countryId'=>$_countryId),false);
    }
    /**
     * Get sessionId value
     * @return string|null
