<?php
/**
 * File for class SpeedyStructListCommonObjects
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructListCommonObjects originally named listCommonObjects
 ...
 * @date 2017-05-16
 */
class SpeedyStructListCommonObjects extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $language;
    /**
     * Constructor method for listCommonObjects
     * @see parent::__construct()
     * @param string $_sessionId
     * @param string $_name
     * @param long $_siteId
     * @param SpeedyEnumParamLanguage $_language
     * @return SpeedyStructListCommonObjects
     */
