<?php
/**
 * File for class SpeedyStructListStreets
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructListStreets originally named listStreets
 ...
 * @date 2017-05-16
 */
class SpeedyStructListStreets extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $language;
    /**
     * Constructor method for listStreets
     * @see parent::__construct()
     * @param string $_sessionId
     * @param string $_name
     * @param long $_siteId
     * @param SpeedyEnumParamLanguage $_language
     * @return SpeedyStructListStreets
     */
