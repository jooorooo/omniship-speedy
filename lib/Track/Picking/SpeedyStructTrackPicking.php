<?php
/**
 * File for class SpeedyStructTrackPicking
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructTrackPicking originally named trackPicking
 ...
 * @date 2017-05-16
 */
class SpeedyStructTrackPicking extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $billOfLading;
    /**
     * Constructor method for trackPicking
     * @see parent::__construct()
     * @param string $_sessionId
     * @param string $_billOfLading
     * @return SpeedyStructTrackPicking
     */
