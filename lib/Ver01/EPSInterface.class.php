...
require_once __DIR__ . '/ServerException.class.php';
require_once __DIR__ . '/ResultAddressString.class.php';
require_once __DIR__ . '/ResultLogin.class.php';
require_once __DIR__ . '/ResultSite.class.php';
require_once __DIR__ . '/ResultSiteEx.class.php';
require_once __DIR__ . '/ResultCourierService.class.php';
require_once __DIR__ . '/ResultCourierServiceExt.class.php';
require_once __DIR__ . '/ResultMinMaxReal.class.php';
require_once __DIR__ . '/ResultStreet.class.php';
require_once __DIR__ . '/ResultQuarter.class.php';
require_once __DIR__ . '/ResultCommonObject.class.php';
require_once __DIR__ . '/ResultOffice.class.php';
require_once __DIR__ . '/ResultOfficeEx.class.php';
require_once __DIR__ . '/ResultClientData.class.php';
require_once __DIR__ . '/ResultAddressSearch.class.php';
require_once __DIR__ . '/ResultCalculation.class.php';
require_once __DIR__ . '/ResultCalculationMS.class.php';
require_once __DIR__ . '/ResultBOL.class.php';
require_once __DIR__ . '/ResultOrderPickingInfo.class.php';
require_once __DIR__ . '/ResultTrackPicking.class.php';
require_once __DIR__ . '/ResultTrackPickingEx.class.php';
require_once __DIR__ . '/ResultSpecialDeliveryRequirement.class.php';
require_once __DIR__ . '/ResultCountry.class.php';
require_once __DIR__ . '/ResultState.class.php';
require_once __DIR__ . '/ResultPickingInfo.class.php';
require_once __DIR__ . '/ResultClientInfo.class.php';
require_once __DIR__ . '/ResultAddressInfo.class.php';
require_once __DIR__ . '/ResultRoutingLabelInfo.class.php';

require_once __DIR__ . '/ResultPickingExtendedInfo.class.php';
require_once __DIR__ . '/ParamCalculation.class.php';
require_once __DIR__ . '/ParamFilterSite.class.php';
require_once __DIR__ . '/ParamAddress.class.php';
require_once __DIR__ . '/ParamAddressSearch.class.php';
require_once __DIR__ . '/ParamFilterCountry.class.php';
require_once __DIR__ . '/ParamLanguage.class.php';
require_once __DIR__ . '/ParamPicking.class.php';
require_once __DIR__ . '/ParamPDF.class.php';
require_once __DIR__ . '/ParamParcel.class.php';
require_once __DIR__ . '/ParamOrder.class.php';
require_once __DIR__ . '/ParamSearchByRefNum.class.php';
require_once __DIR__ . '/ParamClientSearch.class.php';
require_once __DIR__ . '/ParamSearchSecondaryPickings.class.php';
