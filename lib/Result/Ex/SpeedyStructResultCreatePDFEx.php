<?php
/**
 * File for class SpeedyStructResultCreatePDFEx
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructResultCreatePDFEx originally named resultCreatePDFEx
 ...
 * @date 2017-05-16
 */
class SpeedyStructResultCreatePDFEx extends SpeedyWsdlClass
{
    /**
     * The pdfBytes
     * Meta informations extracted from the WSDL
    ...
    public $fullBarcode;
    /**
     * Constructor method for resultCreatePDFEx
     * @see parent::__construct()
     * @param base64Binary $_pdfBytes
     * @param long $_hubId
     ...
     */
    public function __construct($_pdfBytes = NULL,$_hubId = NULL,$_officeId = NULL,$_deadlineDay = NULL,$_deadlineMonth = NULL,$_tourId = NULL,$_fullBarcode = NULL)
    {
        parent::__construct(array('pdfBytes'=>$_pdfBytes,'hubId'=>$_hubId,'officeId'=>$_officeId,'deadlineDay'=>$_deadlineDay,'deadlineMonth'=>$_deadlineMonth,'tourId'=>$_tourId,'fullBarcode'=>$_fullBarcode),false);
    }
    /**
     * Get pdfBytes value
    ...
    /**
     * Set pdfBytes value
     * @param base64Binary $_pdfBytes the pdfBytes
     * @return base64Binary
     */
    public function setPdfBytes($_pdfBytes)
    {
        return ($this->pdfBytes = $_pdfBytes);
    }
    /**
     * Get hubId value
     * @return long|null
