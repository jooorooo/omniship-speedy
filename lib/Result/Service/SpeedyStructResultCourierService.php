<?php
/**
 * File for class SpeedyStructResultCourierService
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructResultCourierService originally named resultCourierService
 ...
 * @date 2017-05-16
 */
class SpeedyStructResultCourierService extends SpeedyWsdlClass
{
    /**
    ...
    public $cargoType;
    /**
     * Constructor method for resultCourierService
     ...
     */
    public function __construct($_allowanceBackDocumentsRequest = NULL,$_allowanceBackReceiptRequest = NULL,$_allowanceCashOnDelivery = NULL,$_allowanceFixedTimeDelivery = NULL,$_allowanceInsurance = NULL,$_allowanceToBeCalled = NULL,$_name = NULL,$_typeId = NULL,$_cargoType = NULL)
    {
        parent::__construct(array('allowanceBackDocumentsRequest'=>$_allowanceBackDocumentsRequest,'allowanceBackReceiptRequest'=>$_allowanceBackReceiptRequest,'allowanceCashOnDelivery'=>$_allowanceCashOnDelivery,'allowanceFixedTimeDelivery'=>$_allowanceFixedTimeDelivery,'allowanceInsurance'=>$_allowanceInsurance,'allowanceToBeCalled'=>$_allowanceToBeCalled,'name'=>$_name,'typeId'=>$_typeId,'cargoType'=>$_cargoType),false);
    }
    /**
