<?php
/**
 * File for class SpeedyStructResultClientInfo
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructResultClientInfo originally named resultClientInfo
 ...
 * @date 2017-05-16
 */
class SpeedyStructResultClientInfo extends SpeedyWsdlClass
{
    /**
     * The address
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var SpeedyStructResultAddressInfo
     */
    public $address;
    /**
     * The clientId
    ...
    public $phones;
    /**
     * Constructor method for resultClientInfo
     * @see parent::__construct()
     * @param SpeedyStructResultAddressInfo $_address
    ...
    /**
     * Get address value
     * @return SpeedyStructResultAddressInfo|null
     */
    ...
    /**
     * Set address value
     * @param SpeedyStructResultAddressInfo $_address the address
