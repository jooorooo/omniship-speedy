<?php
/**
 * File for class SpeedyStructCreatePDFEx
 * @package Speedy
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpeedyStructCreatePDFEx originally named createPDFEx
 ...
 * @date 2017-05-16
 */
class SpeedyStructCreatePDFEx extends SpeedyWsdlClass
{
    /**
     * The sessionId
     * Meta informations extracted from the WSDL
    ...
    public $params;
    /**
     * Constructor method for createPDFEx
     * @see parent::__construct()
     * @param string $_sessionId
     * @param SpeedyStructParamPDF $_params
     * @return SpeedyStructCreatePDFEx
     */
